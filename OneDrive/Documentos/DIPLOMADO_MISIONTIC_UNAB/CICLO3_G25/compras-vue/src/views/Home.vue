        ...
        <div>
            ...
            <form action="#" id="formulario_compra">
                ...
                <select name="producto" id="productos" v-model="seleccion">
                  ...
                  <option v-for="unProducto, llave in listaProductos" v-bind:key="llave" :value="llave">{{unProducto.nombre}} - ${{unProducto.precio}}</option>
                </select>
                ...
                <button @click="procesarInformacion" type="button">Agregar Compra</button>
            </form>                    
    ...
    methods:{
      procesarInformacion(){
        ...
        if (subtotal>5000000) {
            ...
            this.compra.descuento += this.valoresEnvio[this.ompra.envio] - valorEnvio;
        }else{
